package com.sindifisco.portal.model.validation.validator;
...
import com.sindifisco.portal.model.validation.AtributoConfirmacao;
...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object>{
	...
	public boolean isValid(Object object, ConstraintValidatorContext context) {
		...
		try {
			...
			valido = ambosNull(valorAtributo, valorAtributoConfirmacao) ||  ambosSaoIguais(valorAtributo, valorAtributoConfirmacao);
