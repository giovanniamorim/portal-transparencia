...
@Service
public class CadastroModoPagamentoService {
	...
	public void excluir(ModoPagamento modoPagamento) {
		try {
			...
			throw new ImpossivelExcluirEntidadeException("Impossivel apagar este modo de pagamento. O mesmo está relacionado a um ou mais lançamentos");
		}
	}
